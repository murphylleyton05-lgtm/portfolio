...
Modulos:
    ...
    fractura     datos de completacion y normalizacion por rama lateral
    demo_data    generador de datos sinteticos para correr sin descargar
"""

from . import config, declinacion, demo_data, fractura, ingesta, limpieza  # noqa: F401

__version__ = "0.1.0"
__all__ = ["config", "ingesta", "limpieza", "declinacion", "fractura", "demo_data"]
